...
I care about simplicity over cleverness. Code that's easy to read and delete is better than code that tries to be smart.

I'd rather ship something early and learn from real users than polish something that never leaves my branch.

And I think tools should serve the person using them, not the other way around. If a tool creates friction, it's the tool's fault.
